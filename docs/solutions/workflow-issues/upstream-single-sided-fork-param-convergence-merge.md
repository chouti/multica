...
runtime delete instead of destroying them"; internal ticket MUL-5559):
  ...
  - left fork-original helpers in place (auto-merge kept fork side):
      ...
      parseSkillMentionAgents      (handler.go:597,   fork-only — never in upstream)
