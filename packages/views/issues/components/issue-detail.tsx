  ...
  const detailContent = (
    ...
    <div className="relative flex h-full min-w-0 flex-1 flex-col">
        ...
        <div className="mx-auto w-full max-w-4xl px-3 py-6 max-md:pb-chat-launcher md:px-8 md:py-8">
          {/* Fork customization: tappable identifier badge (status icon + copy)
              lives above the title, not in the breadcrumb — the breadcrumb leaf
              must stay a single `{identifier} {title}` text node so upstream's
              `getByText(title)` uniqueness probes keep resolving to the H1. */}
          <div className="mb-2">
          ...
          <div
            className={cn(
              ...
              // can't cover the submit button; sm:pr-0 restores the normal
