...
export function AuthInitializer({
  ...
  const loadConfig = useCallback((): Promise<boolean> => {
    ...
    // Each recovery attempt gets a fresh 8s bound.
    ...
    const request = getApi()
      ...
      .catch(() => {
        ...
        // doesn't show "loading" forever after a fetch failure. Returning
        // false lets the recovery ladder retry; a later success re-settles.
    ...
    return request;
  }, [identity?.version, frontendBaseline]);
