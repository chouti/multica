...
// skill-mention designations are a fork addition layered on the same draft
// entry as upstream's uploads. They round-trip through getDraftPayload and are
// written via setDraftPayload (content + designations together, as the fork
// composer passes them). Review finding #7.
