...
// "closed" vs "completed" — the FZG-341 KTD2 split. Keep in lock-step with the
// Go helpers in server/internal/issueguard/issue_status.go and the Postgres
// functions in server/migrations/214_issue_status_classifier_functions.*.sql.
//
