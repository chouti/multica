...
// validIssueStatuses are the BUILT-IN status keys, present in every
...
// accepted values — see validateIssueStatus. Fork: "archived" rides along as
// an 8th pseudo-builtin (see issueguard); upstream knows 7.
