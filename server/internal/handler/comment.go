...
func (h *Handler) CreateComment(w http.ResponseWriter, r *http.Request) {
	...
	resp.TriggerOutcomes = h.triggerTasksForComment(r.Context(), issue, comment, parentComment, authorType, authorID, originatorUserID, delegationAuthority, suppressAgentIDs, skillMentionAgents)
...
func (h *Handler) UpdateComment(w http.ResponseWriter, r *http.Request) {
	...
	retriggerEditedComment := func() []CommentTriggerOutcome {
		...
		return h.triggerTasksForComment(r.Context(), issue, comment, parentComment, actorType, actorID, h.invokeOriginatorFromRequest(r, actorType, actorID), delegationAuthority, suppressAgentIDs, skillAgents)
	}
